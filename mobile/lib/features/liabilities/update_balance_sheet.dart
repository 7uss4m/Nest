...
class UpdateBalanceSheet extends ConsumerStatefulWidget {
  ...
  const UpdateBalanceSheet({super.key, required this.liability});
...
class _UpdateBalanceSheetState extends ConsumerState<UpdateBalanceSheet> {
  ...
  Future<void> _save() async {
    final balance = double.tryParse(_ctrl.text.trim());
    if (balance == null || balance < 0) return;
    setState(() => _saving = true);
    try {
      final api = ref.read(nestApiProvider);
      final wsId = ref.read(authSessionProvider).workspaceId;
      await api.recordLiabilityBalance(wsId, widget.liability.id, balance);
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Row(children: [
            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              const Text('Update Balance', style: TextStyle(fontFamily: 'InterTight', fontWeight: FontWeight.w700, fontSize: 18, color: NestColors.text1)),
              const SizedBox(height: 2),
              Text(widget.liability.name, style: const TextStyle(fontSize: 13, color: NestColors.text4)),
            ])),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: NestColors.expense.withOpacity(0.08),
            ...
            child: Row(children: [
              ...
              Expanded(
                child: TextField(
                  ...
                  style: const TextStyle(fontSize: 32, fontWeight: FontWeight.w800, color: NestColors.expense, fontFamily: 'InterTight'),
          ...
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            ...
            Text(
              '${paidPct.toStringAsFixed(1)}% paid off',
              style: const TextStyle(fontSize: 12, color: NestColors.income),
            ),
          ]),
          const SizedBox(height: 20),
          SizedBox(
            ...
            child: FilledButton(
              ...
              style: FilledButton.styleFrom(
                backgroundColor: NestColors.income,
                disabledBackgroundColor: NestColors.income.withOpacity(0.4),
              ...
              child: _saving
                ...
                : const Text('Save New Balance', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600)),
            ),
          ),
        ]),
      ),
