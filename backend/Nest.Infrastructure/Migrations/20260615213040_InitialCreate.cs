        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PurchaseCurrency = table.Column<string>(type: "text", nullable: false),
                    CurrentValue = table.Column<decimal>(type: "numeric", nullable: false),
                    Currency = table.Column<string>(type: "text", nullable: false),
                    CurrentValueUpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Liabilities_Assets_LinkedAssetId",
                        column: x => x.LinkedAssetId,
                        principalTable: "Assets",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Liabilities_Workspaces_WorkspaceId",
                        column: x => x.WorkspaceId,
                        principalTable: "Workspaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PlannedPayments_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PlannedPayments_Workspaces_WorkspaceId",
                        column: x => x.WorkspaceId,
                        principalTable: "Workspaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LiabilityBalanceHistory", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LiabilityBalanceHistory_Liabilities_LiabilityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BudgetPeriodEntries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BudgetPeriodEntries_Budgets_BudgetId",
                        column: x => x.BudgetId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BudgetPeriodEntries_BudgetId",
                table: "BudgetPeriodEntries",
                column: "BudgetId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Liabilities_LinkedAssetId",
                table: "Liabilities",
                column: "LinkedAssetId");

            migrationBuilder.CreateIndex(
                name: "IX_Liabilities_WorkspaceId",
                table: "Liabilities",
                column: "WorkspaceId");

            migrationBuilder.CreateIndex(
                name: "IX_LiabilityBalanceHistory_LiabilityId",
                table: "LiabilityBalanceHistory",
                column: "LiabilityId");

            migrationBuilder.CreateIndex(
                name: "IX_PlannedPayments_CategoryId",
                table: "PlannedPayments",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_PlannedPayments_WorkspaceId",
                table: "PlannedPayments",
                column: "WorkspaceId");
